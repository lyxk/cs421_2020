...
fun yyAction41 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringBegin := yypos; YYBEGIN STRING; continue()))
...
fun yyAction46 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (stringBuf := !stringBuf ^ escToCtrl (yytext); continue())
      end
fun yyAction47 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (stringBuf := !stringBuf ^ escToAscii (yytext); continue())
      end
...
fun yyAction50 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (updateNumAndPos (explode yytext, yypos);
			       continue())
      end
...
fun yyAction54 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; commentNum := 1; continue()))
fun yyAction55 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentNum := !commentNum+1; continue()))
...
fun yyAction59 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (Tokens.INT(valOf (Int.fromString(yytext)), yypos,
                               yypos+size(yytext)))
      end
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ73(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ107(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ106(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ111(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ110(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction24(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ113(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
...
fun yyQ45 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ115(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
...
fun yyQ43 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ117(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
       ...
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"5"
              ...
              then if inp <= #"/"
                  then yyAction51(strm, yyNO_MATCH)
                  else yyQ20(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
              else yyAction51(strm, yyNO_MATCH)
      (* end case *))
fun yyQ13 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction51(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ20(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            else if inp < #"0"
              then yyAction51(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ20(strm', yyMATCH(strm, yyAction51, yyNO_MATCH))
            ...
            if inp = #"0"
              ...
              then if inp = #"3"
                  ...
                  then if inp = #"2"
                      ...
                      else yyQ13(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                else if inp = #"\\"
              ...
              then if inp = #"n"
                  then yyQ17(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                  else yyQ9(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp = #"t"
        ...
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #"\\"
                  ...
                  else yyQ24(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"~"
              then yyQ24(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
