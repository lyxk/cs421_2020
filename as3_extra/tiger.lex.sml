...
STRING | STRING_ESCAPE_MULTI | STRING_ESCAPE | COMMENT | INITIAL
...
fun eof () =
    let 
        val pos = hd(!linePos);
    in 
        (if !comDepth <> 0 then err(pos, "unclosed comment") else (); Tokens.EOF(pos,pos) )
    end
...
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN COMMENT; comDepth := !comDepth + 1; continue() ))
fun yyAction45 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN STRING; strMode := true; currString := ""; stringStart := yypos; continue() ))
...
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( comDepth := !comDepth + 1; continue() ))
fun yyAction48 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( comDepth := !comDepth - 1; if !comDepth = 0 then YYBEGIN INITIAL else (); continue() ))
...
fun yyAction51 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        ( YYBEGIN INITIAL; strMode := false; Tokens.STRING(!currString, !stringStart, yypos + size yytext) )
      end
fun yyAction52 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN STRING_ESCAPE; continue() ))
fun yyAction53 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( err(yypos, "illegal character \\t causing unclosed string"); continue() ))
...
fun yyAction56 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN STRING; currString := !currString ^ "\n"; continue() ))
fun yyAction57 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN STRING; currString := !currString ^ "\t"; continue() ))
...
fun yyAction60 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        ( YYBEGIN STRING; currString := !currString ^ String.str( chr( ord( String.sub(yytext, 1) ) - 64 ) ); continue() )
      end
fun yyAction61 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        ( YYBEGIN STRING; currString := !currString ^ String.str ( chr ( valOf (Int.fromString yytext) ) ); continue() )
      end
...
fun yyAction63 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN STRING_ESCAPE_MULTI; continue() ))
fun yyAction64 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        ( err(yypos, "illega escape sequence \\" ^ yytext ^ " inside string"); continue() )
      end
...
fun yyAction68 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        ( err(yypos, "illegal escape sequence \\" ^ yytext ^ " inside string"); continue() )
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction43(strm, yyNO_MATCH)
                      else yyQ70(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ108(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ70(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ107(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ113(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ112(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ70(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ51 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction21(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ114(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
...
fun yyQ49 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction23(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ116(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ47 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction38(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ117(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
...
fun yyQ45 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ119(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
...
fun yyQ30 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction50(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ31(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
...
fun yyQ29 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction50(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ32(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
              else yyAction50(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ14(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
...
in
  (case (!(yyss))
   of STRING => yyQ0(!(yystrm), yyNO_MATCH)
    | STRING_ESCAPE_MULTI => yyQ1(!(yystrm), yyNO_MATCH)
    | STRING_ESCAPE => yyQ2(!(yystrm), yyNO_MATCH)
